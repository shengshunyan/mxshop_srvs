...
func (c *userClient) CheckPassword(ctx context.Context, in *CheckInfo, opts ...grpc.CallOption) (*CheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServer) CheckPassword(context.Context, *CheckInfo) (*CheckResponse, error) {
...
func _User_CheckPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).CheckPassword(ctx, req.(*CheckInfo))
	}
	return interceptor(ctx, in, info, handler)
}
